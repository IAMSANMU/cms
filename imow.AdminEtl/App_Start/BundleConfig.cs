...
namespace imow.AdminEtl
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/H5/css").Include("~/Content/bootstrap.min.css",
                "~/Content/plugins/iCheck/custom.css", "~/Content/style.css"));
            bundles.Add(new ScriptBundle("~/H5/bundles/jquery").Include(
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                      "~/Content/bootstrap.min.css",
                      "~/Content/animate.css",
                      "~/Content/style.css", "~/Content/plugins/sweetalert/sweetalert.css", "~/Content/plugins/iCheck/custom.css"));
            bundles.Add(new StyleBundle("~/plugins/areaStyles").Include("~/Scripts/plugins/bootstrap-chinese-region/bootstrap-chinese-region.min.css"));
            // Font Awesome icons
            ...
            bundles.Add(new ScriptBundle("~/bundles/jquery").Include(
                        "~/Scripts/jquery-2.1.1.min.js", "~/Scripts/plugins/jquery.base64/jquery.base64.js", "~/Scripts/plugins/sweetalert/sweetalert.min.js", "~/Scripts/app/tools.js", "~/Scripts/plugins/iCheck/icheck.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/dataTables").Include(
                      "~/Scripts/plugins/dataTables/datatables.min.js", "~/Scripts/plugins/dataTables/datables.extend.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/validate").Include(
                      "~/Scripts/plugins/validate/jquery.validate.min.js", "~/Scripts/plugins/validate/message_cn.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/datepicker").Include(
                "~/Scripts/plugins/datepicker/bootstrap-datepicker.js", "~/Scripts/plugins/datepicker/locales/bootstrap-datepicker.zh-CN.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/layer").Include(
                "~/Scripts/plugins/layer/layer.js"));


            bundles.Add(new ScriptBundle("~/plugins/loading").Include(
             "~/Scripts/plugins/Loading/loading.js"));
           
            bundles.Add(new ScriptBundle("~/plugins/areajs").Include("~/Scripts/plugins/bootstrap-chinese-region/bootstrap-chinese-region.min.js"));

            bundles.Add(new ScriptBundle("~/bundles/areaTools").Include(
                "~/Scripts/app/areaTools.js"));
