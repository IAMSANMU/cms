...
namespace Imow.Framework.Tool
{
    ...
    public static class TimeHelper
    {
        ...
        /// <summary>
        /// 取得N个月后的最后一天23点59分59秒
        /// </summary>
        /// <param name="datetime"></param>
        /// <param name="count"></param>
        /// <returns></returns>
        public static DateTime LastDayOfMonth(DateTime datetime,int count)
        {
            return DateTime.Parse(datetime.AddDays(1 - datetime.Day).AddMonths(count).ToShortDateString()).AddSeconds(-1);
        }
