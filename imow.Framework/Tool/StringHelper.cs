...
namespace Imow.Framework.Tool
{
    public class StringHelper
    {
        ...
        /// <returns></returns>
        public static string GetSubStringByByte(object value, int length)
        {
            ...
            if (Encoding.Default.GetByteCount(value.ToString()) < 1 + length)
            {
                return value.ToString();
            }
            int i = 0;//字节数
            int j = 0;//实际截取长度
            foreach (char newChar in value.ToString())
            {
                if ((int)newChar > 127)
                {
                    //汉字
                ...
                if (i > length)
                {
                    value = value.ToString().Substring(0, j) + "…";
                    break;
                }
                j++;
            }
        ...
        /// <returns></returns>
        public static string EncryptASC(string Text)
        {
            return EncryptASC(Text, "WebImow");
        }
        /// <summary> 
        /// 加密数据 
        /// </summary> 
        ...
        /// <returns></returns> 
        public static string EncryptASC(string Text, string sKey)
        {
        ...
        /// <param name="Text"></param>
        /// <returns></returns>
        public static string DecryptASC(string Text)
        {
            return DecryptASC(Text, "WebImow");
        }
        /// <summary> 
        /// 解密数据 
        /// </summary> 
        ...
        /// <param name="sKey"></param> 
        /// <returns></returns> 
        public static string DecryptASC(string Text, string sKey)
        {
            DESCryptoServiceProvider des = new DESCryptoServiceProvider();
            int len;
            len = Text.Length / 2;
        ...
        public static string UnBase64(string base64str)
        {
            ...
            try
            {
                ...
                str = System.Text.Encoding.GetEncoding("UTF-8").GetString(data);
            }
            catch (Exception)
            {
        ...
        public static string HideStrWithoutFirstAndLast(string input)
        {
            StringBuilder sb=new StringBuilder();
        ...
        public static string ProMobileNumber(string number)
        {
            return number.Replace(number.Substring(3, 4), "****");
        }

        public static string ProEmail(string number)
        {
            int i = number.IndexOf("@");
            return number.Replace(number.Substring(i - 4 > 0 ? i - 4 : 0, 4), "****");
        }
