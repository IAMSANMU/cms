...
namespace DapperExtensions.Sql
{
    public interface ISqlDialect
    {
        ...
        string GetMultipleJoinSql(List<string> tablenames, List<string> resultList, string joinStr);
    ...
    public abstract class SqlDialectBase : ISqlDialect
    {
        ...
        public virtual string GetMultipleJoinSql(List<string> tablenames, List<string> resultList, string joinStr)
        {
            var tableStr = string.Join(" " + joinStr + " ", tablenames);
