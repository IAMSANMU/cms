...
* 
* 扩展增加Oracle ODP存储过程支持  和支持查询DataSet
*/
using System;
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        /// <summary>
        /// 扩展支持dataset查询 Demo:var mysqlDs = con.ExecuteDataSet(new MySqlDataAdapter(), "select * from test where id=@id", new { id =1 });
        /// </summary>
...
#pragma warning restore 612, 618
    ...
    sealed partial class DefaultTypeMap : SqlMapper.ITypeMap
    {
        ...
        /// </summary>
        public static bool MatchNamesWithUnderscores = true;
    }
